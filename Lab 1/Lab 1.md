# Build and Extend Intelligent Agents
...
1.  Add a new tab in the Edge browser and open the Microsoft 365 Copilot
    app using the following link, and click on **Sign in** **(2)**.
...
4.  From the left pane, select **Apps** **(1)**, then click
    on **OneDrive** **(2)** from the Apps section.
...
5.  Go to **My files**, then click on **+ Create or upload (1)** button
    and select **Folder upload (2)**.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image6.png)

6.  Navigate to C:\LabFiles\Day-1\data **(1)**, click
    on CV **(2)** folder, and select **Upload (3)**.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image7.png)

7.  Select **Upload** on the Upload 5 files to this site? pop-up.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image8.png)

8.  Once again, click on **+ Create or upload (1)** and select **Folder
    upload (2)**.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image6.png)

9.  Navigate to C:\LabFiles\Day-1 **(1)**, click on
    the data **(2)** file, and click on **Upload 3**.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image9.png)

10. Select **Upload** on the Upload 19 files to this site? pop-up.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image10.png)

11. Navigate back to **M365 Copilot**, from the left pane and
    select **Apps** **(1)**, then click on **Copilot** **(2)** from the
    Apps section.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image11.png)

12. Navigate to **Copilot** from the left pane, click **Chat (1)**. Then
    click the **+ (Add)** icon **(2)** at the bottom of the chat pane
    and select **Upload images and files (3)**.

![A screenshot of a chat AI-generated content may be
incorrect.](./media/image12.png)

13. In the file explorer pop-up, navigate
    to C:\LabFiles\Day-1\data\CV **(1)** folder, select **first
    3** **(2)** files and click on **Open** **(3)**.

![A screenshot of a chat AI-generated content may be
incorrect.](./media/image13.png)

14. In the **Copilot chat**, once the **3 files** are uploaded
    successfully, click **enter**.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image14.png)

15. In the active Copilot chat, click the **+ (Add) (1)** icon below the
    message box, then select **Upload images and files (2)**.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image15.png)

16. In the file explorer pop-up, navigate
    to C:\LabFiles\Day-1\Data\CV **(1)** folder, select **last
    2** **(2)** files and click on **Open** **(3)**.

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image16.png)

17. In the **Copilot chat**, once the **2 files (1)** are uploaded
    successfully click on **enter (2)** .

![A screenshot of a computer AI-generated content may be
incorrect.](./media/image17.png)

18. In the Chat box, provide the following prompt **(1)** and hit
    the **Sent (2)** button:
...
1.  In the Chat box, provide the following prompt **(1)** and hit
    the **Sent (2)** button:
...
2.  Following up with the below prompt **(1)** and hitting the **Sent
    (2)** button.
